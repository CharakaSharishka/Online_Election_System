<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="ElectionMgt.WebForm8" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button2" runat="server" CssClass="newStyle9" Text="Candidate Approval" OnClick="Button2_Click"/>
            <asp:Button ID="Button3" runat="server" Text="User Approval" CssClass="newStyle10" OnClick="Button3_Click" />
