<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="ElectionMgt.WebForm3" %>
...
<p>
    ...
    <asp:Label ID="Label3" runat="server" CssClass="newStyle3" Text="Sign In"></asp:Label>
</p>
<p>
    &nbsp;</p>
<p>
